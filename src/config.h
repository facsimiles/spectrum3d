...
/* Define to 1 if you have the `utouch-geis' library > 2.0.11. */
#define GEIS_12 1
...
/* Define to 1 if you have the `utouch-geis' library version 2 (advanced API)
   (-lutouch-geis). */
#define HAVE_LIBUTOUCH_GEIS 1
...
#define PACKAGE_STRING "Spectrum3d 0.2.3"
